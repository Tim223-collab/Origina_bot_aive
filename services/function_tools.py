...
AVAILABLE_FUNCTIONS = [
    ...
    {
        "name": "get_work_stats",
        "description": "Получить статистику работы с сайта (парсинг админ-панели). Используй когда пользователь спрашивает про проверку работников, отчёты, статистику по команде.",
        "parameters": {
            "type": "object",
            "properties": {
                "date": {
